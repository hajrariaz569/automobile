...
public class MHFragment2 extends Fragment {
    View view;
    ListView rejected_mh_LV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_m_h2, container, false);
        rejected_mh_LV = view.findViewById(R.id.rejected_mh_LV);
    ...
    private void GetBookings() {
        ...
        Call<JsonObject> call = service.getBookings(tinyDB.getInt("MECHANIC_ID"), "M", "R");
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            rejected_mh_LV.setAdapter(adapter);
                        }
