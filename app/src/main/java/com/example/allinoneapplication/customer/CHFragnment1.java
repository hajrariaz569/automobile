...
public class CHFragnment1 extends Fragment {

    View view;
    List<MechanicBooking> mechanicBookingList = new ArrayList<>();
    ListView pending_ch_LV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_chfragnment1, container, false);
        pending_ch_LV = view.findViewById(R.id.pending_ch_LV);
        tinyDB = new TinyDB(getContext());
        GetBookings(tinyDB.getInt("CUSTOMERID"), "P");
        Constant.STATUS = "P";
        return view;
    }
                    ...
                    if (response.code() == 200) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                pending_ch_LV.setAdapter(adapter);
