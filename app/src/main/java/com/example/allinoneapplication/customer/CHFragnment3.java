...
public class CHFragnment3 extends Fragment {

    View view;
    ListView accepted_ch_LV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_chfragnment3, container, false);
        accepted_ch_LV = view.findViewById(R.id.accepted_ch_LV);
        tinyDB = new TinyDB(getContext());
        GetBookings(tinyDB.getInt("CUSTOMERID"), "C");
        Constant.STATUS = "C";
        return view;
    }
                    ...
                    if (response.code() == 200) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                accepted_ch_LV.setAdapter(adapter);
