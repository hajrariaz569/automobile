...
public class CompletedComplaintFragment extends Fragment {
    ...
    View view;
    TextView tv_no_cmp_comp;
    RecyclerView cmp_comp_Recycler;
    int code;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_completed_complaint, container, false);
        tv_no_cmp_comp = view.findViewById(R.id.tv_no_cmp_comp);
        cmp_comp_Recycler = view.findViewById(R.id.cmp_comp_Recycler);
                    ...
                    if (code == 200) {
                        try {
                            ...
                            if (complaintList.size() != 0) {
                                tv_no_cmp_comp.setVisibility(View.GONE);
                                adapter = new ComplaintHistoryAdapter(complaintList, getActivity());
                                cmp_comp_Recycler.setAdapter(adapter);
                                cmp_comp_Recycler.setHasFixedSize(true);
                                cmp_comp_Recycler.setLayoutManager(new LinearLayoutManager(getActivity()));
                                adapter.notifyDataSetChanged();
                            } else {
                                tv_no_cmp_comp.setVisibility(View.VISIBLE);
                                cmp_comp_Recycler.setVisibility(View.GONE);
                            }
